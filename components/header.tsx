    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Заменил текстовый логотип на SVG */}
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {/*<a href="#auctions" className="font-bold text-gray-700 hover:text-primary transition-colors">*/}
            {/*  Аукціони*/}
            {/*</a>*/}
          ...
          <button onClick={toggleMenu} className="md:hidden p-2 text-gray-700 hover:text-primary">
